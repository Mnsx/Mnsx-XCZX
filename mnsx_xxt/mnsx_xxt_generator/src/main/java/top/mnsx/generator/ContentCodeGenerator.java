...
public class ContentCodeGenerator {
	...
	//数据库密码
	private static final String DATA_SOURCE_PASSWORD  = "xx1527030652";
	//生成的表
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/mnsx_xxt_generator/src/main/java");
		gc.setAuthor("mnsx");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.32.130:3306/xxt_" + SERVICE_NAME
